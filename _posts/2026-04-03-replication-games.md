...
tags: slides
---
**Paolo Corsetto** (INRAE, UMR GAEL Grenoble) et **Valérie Orozco** (INRAE, UMR TSE-R Toulouse)

Titre : Qu'est ce que des Replication Games ? Pour qui et pourquoi ?

*Résumé : Ces événements réunissent des chercheurs, ingénieurs et doctorants, pour reproduire, en une journée, des études publiées dans des revues scientifiques de premier plan. L’objectif est de vérifier la robustesse et la fiabilité des résultats de recherche, un enjeu central pour la crédibilité de la science. Les Replication Games ont lieu plusieurs fois par an, dans différents pays, et s’adressent à des chercheurs de tous niveaux.
...
Le webinaire aura lieu sur ce lien :
